  ...
  return (
    <footer className="bg-black border-t border-white/10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 md:py-12">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="space-y-3">
              <a 
                ...
                className="flex items-start gap-3 text-sm text-white/70 hover:text-primary transition-colors"
              >
        ...
        {/* Copyright */}
        <div className="pt-6 sm:pt-8 border-t border-white/10 text-center text-xs sm:text-sm text-white/70">
